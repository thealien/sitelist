	...
	*/
	public function setBody($body = '', $contentType = null, $charset = null) {
		if ($this->view !== null) {
			...
			//$viewPath = Yii::getPathOfAlias(Yii::app()->mail->viewPath.'.'.$this->view) . $this->viewExtention;
			//$body = $controller->renderInternal($viewPath, array_merge($body, array('mail'=>$this)), true);
			$body = $controller->render(Yii::app()->mail->viewPath.'.'.$this->view, $body, true);
		}
